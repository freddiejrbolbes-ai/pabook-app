...
def provider_dashboard(provider_id):
    ...
    is_unlocked = unlock_code == provider.access_code or request.args.get("secret") == os.environ.get("ADMIN_SECRET", "changeme") or request.args.get("secret") == os.environ.get("ADMIN_SECRET", "changeme")
    if request.method == "POST":
